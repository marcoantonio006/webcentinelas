...
class Constancia {
    ...
    public static function generar(array $datos) {
        ...
        $tiene_representante  = $datos['tiene_representante'] ?? false;
        ...
        $n(' portador de la cedula de identidad No.: V.- ');
        ...
        $n(', y debe incorporarse a los entrenamientos desde ');
        ...
        if ($tiene_representante) {
            ...
            $n(', mayor de edad, titular de la Cedula de Identidad, V- ');
            $bu($cedula_representante, '__________');
            $n(', representante de la ');
            $b('ATLETA: ');
            $bu($n_at, '______________________________');
            $n(', titular de la C.I. No.: V ');
            $bu($cedula_atleta, '__________');
            $n(', para que asista al CAMPEONATO ');
            $bu($nombre_torneo, '_____________________________');
            $n(' QUE SE REALIZARA EN ');
            $bu($estado_torneo, '____________________');
            $n(' DE ');
            $bu($fecha_torneo_inicio, '______');
            $n(' DE ');
            ...
            $n(', mayor de edad, titular de la Cedula de Identidad, V- ');
            $bu($cedula_atleta, '__________');
            $n(', autorizo mi participacion en el CAMPEONATO ');
            $bu($nombre_torneo, '_____________________________');
            $n(' QUE SE REALIZARA EN ');
            $bu($estado_torneo, '____________________');
            $n(' DE ');
        ...
        $pdf->MultiCell(0, $lhs, txt('Articulo 79. Se la consideran faltas a la presente LEY SANCIONABLES CON MULTAS ENTRE MIL UNIDADES TRIBUTARIAS (1.000 U.T) Y TRES MIL QUINIENTAS UNIDADES TRIBUTARIAS (3.500 U.T)'), 0, 'J');
        $pdf->SetX(20);
