...
if (!$datos) { header('Location: /centinela/admin/eventos/index.php'); exit; }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // ── Imagen: mantener la actual o reemplazar ────
    $imagenFinal = $datos['imagen']; // por defecto se mantiene la existente
    ...
    if (empty($errores)) {
        ...
        if ($imagenFinal !== $datos['imagen'] && !empty($imagenFinal)) {
            // Subió imagen nueva: mover el archivo nuevo
